            ...
            <div class="king-layout1-content" style="margin-left: 216px;">
                ...
                <div class="panel panel-default mb0">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- 设置面板Start -->
                        <template id="header_tpl_1496219958811">
                            <tr>
                        ...
                        <!-- 设置面板Start -->
                        <template id="header_tpl_1496220006756">
                            <tr>
                                <th style="width: 100px;">#index#</th>
                                <th style="width: 20%;">#task#</th>
                                <th style="width: 20%;">#progress#</th>
    ...
    $(function(){
        ...
        $.ajax({
            ...
            success: function(res){
                var _html = ' ';
                var list = res.items;
                var tpl = $('#tpl_1496219958811').html();
                var headerTpl =  $('#header_tpl_1496219958811').html();
                for (var i=0,len=list.length; i < len; i++){
                    var item = list[i];
                    _html += renderTpl(tpl, item)
                }
                $('#code_1496219958811 tbody').html(_html);
    ...
    $(function(){
        ...
        $.ajax({
            ...
            success: function(res){
                var _html = ' ';
                var list = res.items;
                var tpl = $('#tpl_1496220006756').html();
                var headerTpl =  $('#header_tpl_1496220006756').html();
                for (var i=0,len=list.length; i < len; i++){
                    var item = list[i];
                    _html += renderTpl(tpl, item)
                }
                $('#code_1496220006756 tbody').html(_html);
                $('.ranger-box thead').html(renderTpl(headerTpl,res.catalogues));
            }
        });
    });
