            ...
            <div class="king-layout1-content" style="margin-left: 216px;">
                ...
                <div class="king-page-topbar ml15">
                    ...
                    <ul class="breadcrumb king-breadcrumb pl0 bg-transparent">
                        ...
                        <li><a href="javascript:void(0);">演出计划查询</a></li>
                    </ul>
                </div>
                <!-- 面板 编辑 开始 -->
                <!-- 面板 编辑 结束 -->
                <div class="panel panel-default mb0">
                    <div class="panel-heading"> 演出计划查询 </div>
                    <div class="panel-body">
                                        ...
                                        <div class="form-group clearfix ">
                                            ...
                                            <div class="col-sm-9">
                                                <select name="time" class="form-control bk-valign-top">
                                                    <%
                                                        ArrayList<Schedule> sche=(ArrayList<Schedule>)request.getAttribute("schedule");
                                                        for (Schedule schedule:sche) {
                                                    %>
                                                    <option value="<%=schedule.getTime()%>"><%=schedule.getTime()%></option>
                                                    <%
                                                        }
                                                    %>
                                                </select>
                        ...
                        <table class="table mb0 pr15 ranger-box2 table-striped table-bordered table-header-bg table-out-bordered table-hover  table-striped table-bordered table-header-bg table-out-bordered table-hover ">
                            ...
                            <tr>
                                ...
                                <th style="width: 15%;">演出厅#</th>
                                <th style="width: 25%;">剧目</th>
                                <th style="width: 25%;">时间</th>
                                <th style="width: 15%;">票价</th>
                                <th style="width: 15%">折扣</th>
                                <th style="width: 15%">余票</th>
                            </tr>
                            </thead>
                            <tbody>
                            <%
                            ...
                            <tr>
                                ...
                                <td width="20%"><%=schedules.get(i).getStudio_id()%></td>
                                <td width="25%"><%=playDAO.getPlayByID(schedules.get(i).getPlay_id()).getName()%></td>
                                <td width="25%"><%=schedules.get(i).getTime()%></td>
                                <td width="20%"><%=schedules.get(i).getPrice()%></td>
                                <td width="20%"><%=schedules.get(i).getDiscount()%></td>
                                <td width="20%"><%
                                    if (schedules.get(i).getStatus()==1){
                                         count++;
                                    }
                                    out.println(count);
                                %></td>
