            ...
            <div class="king-layout1-content" style="margin-left: 216px;">
                ...
                <div class="king-page-topbar ml15">
                    ...
                    <ul class="breadcrumb king-breadcrumb pl0 bg-transparent">
                        ...
                        <li><a href="javascript:void(0);">售票</a></li>
                    </ul>
                </div>
                <!-- 面板 编辑 开始 -->
                <!-- 面板 编辑 结束 -->
                <div class="panel panel-default mb0">
                    ...
                    <div class="panel-body">
                        ...
                        <!-- 设置面板Start -->
                        <template id="header_tpl_1496217400735">
                            <tr>
                                    ...
                                    <div class="col-md-4">
                                        <div class="container-fluid mb0 ">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group clearfix ">
                                                        <label class="col-sm-3 control-label bk-lh30 pt0">演出计划ID：</label>
                                                        <div class="col-sm-9">
                                                            <select name="" id="" class="form-control bk-valign-top">
                                                                <option value="选择项1">选择项1</option>
                                                                <option value="选择项2">选择项2</option>
    ...
    $(function(){
        ...
        $.ajax({
            ...
            success: function(res){
                var _html = ' ';
                var list = res.items;
                var tpl = $('#tpl_1496217400735').html();
                var headerTpl =  $('#header_tpl_1496217400735').html();
                for (var i=0,len=list.length; i < len; i++){
                    var item = list[i];
                    _html += renderTpl(tpl, item)
                }
                $('#code_1496217400735 tbody').html(_html);
