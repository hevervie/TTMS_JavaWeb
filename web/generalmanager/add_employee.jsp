                ...
                <div class="king-layout1-content" style="margin-left: 216px;">
                    ...
                    <div class="king-page-topbar ml15">
                        ...
                        <ul class="breadcrumb king-breadcrumb pl0 bg-transparent">
                            ...
                            <li><a href="/generalmanager/employee_manager">人事管理</a></li>
                            <li class="active">添加剧院经理</li>
                        </ul>
                    </div>
                    <!-- 面板 编辑 开始 -->
                    <!-- 面板 编辑 结束 -->
                        ...
                        <div class="panel-body">
                            <div class="container-fluid mb0 ">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <form class="form-horizontal" action="/generalmanager/add_employee" method="post">
                                            <div class="form-group clearfix ">
                                                <label class="col-sm-3 control-label bk-lh30 pt0">剧院：</label>
                                                <div class="col-sm-9">
                                                    <select name="theater" class="form-control bk-valign-top">
                                                     <%
                                                        ...
                                                        {
                                                    %>
                                                        <option value="<%=theater.get(i).getId()%>"><%=theater.get(i).getName()%></option>
                                                    <%
                                                            }
                                                        }
                                                    %>
                                            ...
                                            <div class="form-group clearfix ">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control bk-valign-top" id="" name="emp_no" placeholder="请输入工号"> </div>
                                            </div>
                                            <div class="form-group clearfix ">
                                                <label class="col-sm-3 control-label bk-lh30 pt0">姓名：</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control bk-valign-top" id="" name="emp_name" placeholder="请输入姓名"> </div>
                                            </div>
                                            <div class="form-group clearfix ">
                                                <label class="col-sm-3 control-label bk-lh30 pt0">登录密码：</label>
                                                <div class="col-sm-9">
                                                    <input type="password" class="form-control bk-valign-top" id="" name="emp_passwd"placeholder="请输入密码">
                                            ...
                                            <div class="form-group clearfix">
                                                <div class="col-sm-9 col-sm-offset-3">
                                                    ...
                                                    <a href="/generalmanager/add_employee"><button type="button" class="king-btn king-default ">取消</button></a>
                                                    <div style="color: red">
                                                        <br/>
                                                        <br/>
                                                        <br/>
