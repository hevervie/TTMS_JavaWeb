                        ...
                        <div class="panel-body">
                            <div class="container-fluid mb0 ">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <form class="form-horizontal" action="/generalmanager/change_passwd" method="post">
                                            ...
                                            <div class="form-group clearfix">
                                                <div class="col-sm-9 col-sm-offset-3">
                                                    ...
                                                    <a href="/generalmanager/change_passwd"><button type="button" class="king-btn king-default ">取消</button></a>
                                                </div>
                                            </div>
                                            <div class="form-group clearfix">
