            ...
            <div class="king-layout1-content" style="margin-left: 216px;">
                <div class="king-page-topbar ml15">
                    <ul class="breadcrumb king-breadcrumb pl0 bg-transparent">
                        ...
                        <li><a href="/managers/studio/">影厅管理</a></li>
                        <li>添加影厅</li>
                    </ul>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="container-fluid mb0 ">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <form class="form-horizontal" action="/managers/studio/add/" method="post">
                                        <div class="form-group clearfix ">
                                            <label class="col-sm-3 control-label bk-lh30 pt0">影厅名称：</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control bk-valign-top" name="studio_name"
                                                       placeholder="请输入演出厅名称"></div>
                                        </div>
                                        <div class="form-group clearfix ">
                                            <label class="col-sm-3 control-label bk-lh30 pt0">行数：</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control bk-valign-top" name="studio_row"
                                                       placeholder="请输入行数"></div>
                                        </div>
                                        <div class="form-group clearfix ">
                                            <label class="col-sm-3 control-label bk-lh30 pt0">列数：</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control bk-valign-top" name="studio_col"
                                                       placeholder="请输入列数"></div>
                                        </div>
                                        <div class="form-group clearfix">
                                            <div class="col-sm-9 col-sm-offset-3">
                                                <button type="submit" class="king-btn mr10  king-success">提交</button>
                                                <a href="/managers/studio/">
