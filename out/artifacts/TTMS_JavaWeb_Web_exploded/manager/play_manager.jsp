...
<%@ page import="edu.xupt.cs.se.dao.LevelDAO" %>
<%@ page import="edu.xupt.cs.se.model.Lang" %>
<%@ page import="edu.xupt.cs.se.dao.LangDAO" %>
<%@ page import="edu.xupt.cs.se.model.Type" %>
<%@ page import="edu.xupt.cs.se.dao.TypeDAO" %><%--
                ...
                <div class="panel panel-default mb0">
                    ...
                    <div class="panel-body">
                        <div style="margin-bottom: 15px">
                            <a href="/managers/movie/add/">
                                <button type="button" class="king-btn mr10  king-success">添加影片</button>
                            </a>
                        </div>
                        <table class="table mb0 pr15 ranger-box2 table-striped table-bordered table-header-bg table-out-bordered table-hover  table-striped table-bordered table-header-bg table-out-bordered table-hover ">
                            ...
                            %>
                            <tr>
                                <td style="width: 70px;"><%=play.getId()%></td>
                                <td style="width: 30%;"><%=play.getName()%></td>
                                <td style="width: 5%;"><%=typeDAO.getTypeByID(play.getType_id()).getType()%></td>
                                <td style="width: 5%;"><%=langDAO.getLangByID(play.getLang_id()).getType()%></td>
                                <td style="width: 5%;"><%=levelDAO.getLevelByID(play.getLevel_id()).getType()%></td>
                                <td style="width: 5%;"><%=play.getScore()%></td>
                                <td style="width: 15%;"><%=play.getLength()%></td>
